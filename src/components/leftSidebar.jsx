...
function Leftsidebar(){
    return(
        <div className=" fixed mx-4 my4 font-medium">
            ...
            <div className="flex justify-between logo_section">
                    <div className='flex mt-5'>
                        ...
                        <div className=''> <BiMenu className='icon_slider mr-4 bg-purple-200 rounded-lg hover:bg-purple-500 ml-28 mt-2' /> </div>
                    </div>
                ...
                <div className="overflow-y-auto py-4 px-3 rounded mt-5">
                    <span>Dashboard</span>
