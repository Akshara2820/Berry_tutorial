...
function Card_chart2() {
  return (
    <>
        ...
        <div className="mx-5 ">
          <div className="rounded-lg mx-4  bg-violet-100 ">
            <div className='flex justify-between'>
              <div></div>
          ...
          <div className='mx-4  '>
            <div className="relative sm:rounded-lg">
              <table className="w-full text-sm text-left text-gray-500">
                ...
                <div className='text-blue-600 font-bold mx-4  ml-40 mt-10 view_all_button'> View All</div>
              </table>
            </div>
          </div>
        </div>
